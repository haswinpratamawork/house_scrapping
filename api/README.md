...
HOST=127.0.0.1 PORT=8000 ./api/run_api.sh
```
...
docker run -p 8000:8000 -e GOOGLE_MAPS_API_KEY=AIza... collateral_scrapping
```
...
docker run -d --name collateral_scrapping --restart unless-stopped \
  -p 8000:8000 -e GOOGLE_MAPS_API_KEY=AIza... collateral_scrapping
